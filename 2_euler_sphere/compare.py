...
if __name__ == "__main__":
    ...
    jobs.append(hst.ConvergenceHistory("pp_data/h1_p1.hst"))
    jobs.append(hst.ConvergenceHistory("pp_data/h1_p2.hst"))
    jobs.append(hst.ConvergenceHistory("pp_data/h1_p3.hst"))
    jobs.append(hst.ConvergenceHistory("pp_data/h1_p4.hst"))
    jobs.append(hst.ConvergenceHistory("pp_data/h1_p4_.hst"))
