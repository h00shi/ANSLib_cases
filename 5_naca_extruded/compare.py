...
if __name__ == "__main__":
    ...
    jobs.append(hst.ConvergenceHistory("pp_data/D3_p3_lines.hst"))
    # jobs.append(hst.ConvergenceHistory("pp_data/D3_p3_lines.hst"))
    jobs.append(hst.ConvergenceHistory("pp_data/D3_p4_lines.hst"))

    jobs.append(hst.ConvergenceHistory("pp_data/T3_p3_tri.hst"))
