...
for p in pset:
    comname = 'T%d_p%d' % (d,p)
    file_name = 'options/' + comname + '_tri.opt'
    f = open(file_name, 'w')
    ...
    f.write('\n# --------------------------------- FILE NAMES\n')
    f.write('-f   MESH/airfoilt \n')
    f.write('-fec MESH/airfoilt \n')
    f.write('-B   MESH/airfoilt \n')
    ...
    f.write('-ita_history_name pp_data/' + comname + '_tri.hst\n')
